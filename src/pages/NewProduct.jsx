...
export default function NewProduct() {
    ...
    const getFileName = (fileNames) => {
        ...
        // setPreview(`http://15.164.100.230:9000/${fileNames.uploadFileName}`);   
    ...
    const handleSubmit = (e) => {
        ...
        if(productNameRef.current.value === '') {
            ...
            axios   
                .post('http://15.164.100.230:9000/product/new', formData)
                .then(res => {
                    ...
                    <li>
                        ...
                        {/** 다중파일 preview */}
                        {
                            previewList && previewList.map((preview)=>
                                <img src={`http://15.164.100.230:9000/${preview}`}  
                                    alt="preview image"
