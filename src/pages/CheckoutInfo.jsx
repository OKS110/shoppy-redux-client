...
return (
            ...
            { orderList && orderList.map(item => 
                <>
                    ...
                    <div className="value">
                        ...
                        {item.pname}, {item.info}, 수량({item.qty}), 가격({Number(item.price || 0).toLocaleString()}원)
                    )
                    </div>
                </>
            )}
    ...
    <div class="section">
        ...
        <tr>
            <td>총상품가격</td>
            <td class="price">{Number(totalPrice || 0).toLocaleString()}원</td>
        </tr>
        <tr>
            <td>즉시할인</td>
        ...
        <tr class="total">
            <td>총결제금액</td>
            <td class="total-price">{Number(totalPrice || 0).toLocaleString()}원</td>
        </tr>
        </table>
    </div>
